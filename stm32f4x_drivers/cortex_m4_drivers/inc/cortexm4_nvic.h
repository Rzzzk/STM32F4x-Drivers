...
#ifndef CORTEX_M4_DRIVERS_INC_CORTEXM4_NVIC_H_
#define CORTEX_M4_DRIVERS_INC_CORTEXM4_NVIC_H_
...
typedef enum
{
	PriGrField_4_GoupPriBits_0_SubpriBits=0,
	PriGrField_3_GoupPriBits_1_SubpriBits,
	PriGrField_2_GoupPriBits_2_SubpriBits,
	PriGrField_1_GoupPriBits_3_SubpriBits,
	PriGrField_0_GoupPriBits_4_SubpriBits,
}SCB_PriGro_t;
...
typedef struct
{
	u8 GroupPriority;
	u8 SubPriority;
	NVIC_PenFlage_t PendingFlag;
	NVIC_ActvFlage_t AvtiveFalg;
...
#endif /* CORTEX_M4_DRIVERS_INC_CORTEXM4_NVIC_H_ */
